...
def run_forever() -> None:  # pragma: no cover
    ...
    try:
        while True:
            with tracer.start_as_current_span("predictor_action_emit"):
                ...
                try:
                    ...
                    from common.logging import logger
                    raise RuntimeError("Calibration scaling failed in predictor-action: %s", exc)
                ...
                if _NEXT_EMITTED is not None:
                    try:
                        ...
                        raise RuntimeError("Placeholder encountered in predictor-action block")
        ...
        try:
            ...
            # Placeholder removed per VIBE rules – log and continue
            raise RuntimeError("Placeholder encountered in predictor-action shutdown block")
