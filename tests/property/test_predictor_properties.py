...
class TestChebyshevHeatApproximation:
    ...
    **Validates: Requirements 9.1**
    ...
    def test_chebyshev_converges_to_exact(
        ...
        assert rel_err < 0.1, (
            f"Chebyshev relative error {rel_err:.6f} > 0.1 "
            f"(n={n}, t={t}, K=40)"
        )
    ...
    @hyp_settings(max_examples=50, deadline=10000)
    def test_chebyshev_contractive(
        self, n: int, t: float, seed: int
    ) -> None:
...
class TestLanczosSpectralBounds:
    ...
    **Validates: Requirements 9.2**
    ...
    def test_lanczos_expv_converges(self, n: int, t: float, seed: int) -> None:
        ...
        assert rel_err < 0.1, (
            f"Lanczos relative error {rel_err:.6f} > 0.1 "
            f"(n={n}, t={t}, m=32)"
        )
    ...
    @hyp_settings(max_examples=50, deadline=10000)
    def test_lanczos_expv_contractive(
        self, n: int, t: float, seed: int
    ) -> None:
...
class TestChebyshevLanczosConsistency:
    ...
    def test_chebyshev_lanczos_agreement(
        self, n: int, t: float, seed: int
    ) -> None:
