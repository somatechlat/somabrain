...
def test_wm_salience_and_admit_if_salient():
    ...
    # Next vector similar -> lower novelty; still may admit if threshold low
    admitted2 = wm.admit_if_salient(v, {"i": 2}, threshold=0.9)
    # May be False depending on vector; just ensure function returns bool and items not exceed max
