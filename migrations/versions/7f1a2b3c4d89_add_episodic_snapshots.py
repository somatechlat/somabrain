...
def upgrade() -> None:
    ...
    op.create_index("ix_episodic_snapshots_tenant_created", "episodic_snapshots", ["tenant_id", "created_at"], unique=False)


def downgrade() -> None:
    op.drop_index("ix_episodic_snapshots_tenant_created", table_name="episodic_snapshots")
