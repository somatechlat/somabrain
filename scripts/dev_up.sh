...
# After the Python block that writes allocated ports, force the standard ports
cat <<'PORTS' >> $ENVFILE
...
port_map={'somabrain':'9696','redis':'6379','kafka':'9092','prometheus':'9090','postgres':'5432','somamemory':'9595'}
for s in services:
    try:
