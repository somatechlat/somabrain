...
os.environ['SOMABRAIN_MEMORY_HTTP_ENDPOINT'] = os.environ.get('SOMABRAIN_MEMORY_HTTP_ENDPOINT','http://host.docker.internal:9595')
...
print('ENV SOMABRAIN_MEMORY_HTTP_ENDPOINT=', os.environ.get('SOMABRAIN_MEMORY_HTTP_ENDPOINT'))
