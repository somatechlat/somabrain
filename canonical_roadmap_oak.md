...
|----------------|-----------|-------|----------------|
| SB‑FR‑101 | `somabrain/option_manager.py` | `tests/unit/test_option_manager.py` | `docs/technical-manual/oak_integration.md` |
...
| SB‑FR‑060 (OPA) | `somabrain/opa/middleware.py` | `tests/security/test_opa_enforcement.py` | `docs/technical-manual/security.md` |
| ... | ... | ... | ... |
