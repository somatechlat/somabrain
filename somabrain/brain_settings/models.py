...
BRAIN_DEFAULTS = {
    ...
    "sleep_t0": {"v": 1.0, "cat": "RESOURCE", "learnable": True, "min": 0.1, "max": 10.0},
    "sleep_tau0": {"v": 0.1, "cat": "RESOURCE", "learnable": True, "min": 0.01, "max": 1.0},
    "sleep_eta0": {"v": 0.01, "cat": "RESOURCE", "learnable": True, "min": 0.001, "max": 1.0},
    "sleep_lambda0": {"v": 0.5, "cat": "RESOURCE", "learnable": True, "min": 0.01, "max": 1.0},
    "sleep_b0": {"v": 1.0, "cat": "RESOURCE", "learnable": True, "min": 0.1, "max": 10.0},
    "sleep_k_min": {"v": 5, "cat": "RESOURCE", "learnable": False, "min": 1, "max": 100},
    "sleep_t_min": {"v": 0.5, "cat": "RESOURCE", "learnable": False, "min": 0.1, "max": 5.0},
    "sleep_alpha_k": {"v": 0.1, "cat": "RESOURCE", "learnable": True, "min": 0.0, "max": 1.0},
    "sleep_alpha_t": {"v": 0.05, "cat": "RESOURCE", "learnable": True, "min": 0.0, "max": 1.0},
    "sleep_alpha_tau": {"v": 0.05, "cat": "RESOURCE", "learnable": True, "min": 0.0, "max": 1.0},
    "sleep_alpha_eta": {"v": 0.01, "cat": "RESOURCE", "learnable": True, "min": 0.0, "max": 1.0},
    "sleep_beta_b": {"v": 0.1, "cat": "RESOURCE", "learnable": True, "min": 0.0, "max": 1.0},
