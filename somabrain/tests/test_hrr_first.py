...
def main():
    ...
    r = client.post("/remember", json={"coord": None, "payload": {"task": "alpha token", "importance": 2, "memory_type": "episodic"}})
    assert r.status_code == 200
    r = client.post("/remember", json={"coord": None, "payload": {"task": "beta token", "importance": 2, "memory_type": "episodic"}})
    assert r.status_code == 200
