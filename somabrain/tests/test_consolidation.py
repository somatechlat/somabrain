...
def main():
    ...
    stats_n = cons.run_nrem("public", app_mod.cfg, app_mod.mt_wm, app_mod.mt_memory, top_k=3, max_summaries=2)
    assert stats_n["created"] >= 1
    stats_r = cons.run_rem("public", app_mod.cfg, app_mod.mt_wm, app_mod.mt_memory, recomb_rate=0.5, max_summaries=2)
