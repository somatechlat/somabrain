...
def main():
    # Use stub memory for predictable behavior
    os.environ["SOMABRAIN_MEMORY_MODE"] = "stub"
    ...
    client.post("/remember", json={"coord": None, "payload": {"task": "seed", "importance": 1, "memory_type": "episodic"}})
    r = client.post("/recall", json={"query": "q2", "top_k": 2}, headers={"X-Min-Sources": "1"})
    assert r.status_code == 200
    data2 = r.json()
