...
quantum_spectral_property = Gauge(
    'quantum_hrr_spectral_property',
    'Verify |H_k|≈1 for all operations',
    ['operation']
)
...
quantum_role_orthogonality = Gauge(
    'quantum_role_orthogonality',
    'Verify role vector orthogonality',
    ['role_pair']
)
...
operation_correctness = Gauge(
    'operation_mathematical_correctness',
