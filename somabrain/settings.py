...
INSTALLED_APPS = [
    ...
    "somabrain.apps.SomaBrainConfig",  # Main app with runtime init
...
# GMD MathCore v4.0 (Theorem 1-3 Support)
SOMABRAIN_GMD_DELTA = env.float("SOMABRAIN_GMD_DELTA", default=0.01)
SOMABRAIN_GMD_EPSILON = env.float("SOMABRAIN_GMD_EPSILON", default=0.05)
SOMABRAIN_GMD_ETA = env.float("SOMABRAIN_GMD_ETA", default=0.08)
SOMABRAIN_GMD_ALPHA = env.float("SOMABRAIN_GMD_ALPHA", default=640.0)
SOMABRAIN_GMD_TARGET_GAMMA = env.float("SOMABRAIN_GMD_TARGET_GAMMA", default=0.8)
SOMABRAIN_GMD_LAMBDA_REG = env.float("SOMABRAIN_GMD_LAMBDA_REG", default=2.05e-5)
SOMABRAIN_GMD_QUANTIZATION_BITS = env.int("SOMABRAIN_GMD_QUANTIZATION_BITS", default=8)
