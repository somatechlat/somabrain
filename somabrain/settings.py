...
MIDDLEWARE = [
    ...
    # 'somabrain.controls.opa_middleware.OpaMiddleware',  # Disabled for local dev - no OPA server
]
...
DATABASES = {
    'default': env.db('SOMABRAIN_POSTGRES_DSN', default='postgresql://localhost/somabrain')
}
...
SOMABRAIN_PROVENANCE_STRICT_DENY = env.bool('SOMABRAIN_PROVENANCE_STRICT_DENY', default=False)
...
SOMABRAIN_CONSTITUTION_PUBKEY_PATH = env.str('SOMABRAIN_CONSTITUTION_PUBKEY_PATH', default=None)
SOMABRAIN_CONSTITUTION_PRIVKEY_PATH = env.str('SOMABRAIN_CONSTITUTION_PRIVKEY_PATH', default=None)
SOMABRAIN_CONSTITUTION_THRESHOLD = env.int('SOMABRAIN_CONSTITUTION_THRESHOLD', default=1)
SOMABRAIN_CONSTITUTION_SIGNER_ID = env.str('SOMABRAIN_CONSTITUTION_SIGNER_ID', default='default')

# Feature flags
SOMABRAIN_MINIMAL_PUBLIC_API = env.bool('SOMABRAIN_MINIMAL_PUBLIC_API', default=False)
SOMABRAIN_ALLOW_ANONYMOUS_TENANTS = env.bool('SOMABRAIN_ALLOW_ANONYMOUS_TENANTS', default=False)
...
SOMABRAIN_FEATURE_OVERRIDES = env.str('SOMABRAIN_FEATURE_OVERRIDES', default='./data/feature_overrides.json')
...
# Orchestrator
SOMABRAIN_ORCH_CONSUMER_GROUP = env.str('SOMABRAIN_ORCH_CONSUMER_GROUP', default='orchestrator-service')
...
SOMABRAIN_REWARD_PRODUCER_HOST_PORT = env.int('REWARD_PRODUCER_HOST_PORT', default=30183)
...
# Redis
SOMABRAIN_REDIS_URL = env.str('SOMABRAIN_REDIS_URL', default=env.str('REDIS_URL', default=''))
SOMABRAIN_REDIS_HOST = env.str('SOMABRAIN_REDIS_HOST', default=env.str('REDIS_HOST', default=None))
SOMABRAIN_REDIS_PORT = env.int('SOMABRAIN_REDIS_PORT', default=env.int('REDIS_PORT', default=6379))
SOMABRAIN_REDIS_DB = env.int('SOMABRAIN_REDIS_DB', default=env.int('REDIS_DB', default=0))

# Kafka
KAFKA_BOOTSTRAP_SERVERS = env.str('KAFKA_BOOTSTRAP_SERVERS', default=env.str('SOMABRAIN_KAFKA_URL', default='')).replace('kafka://', '')
SOMABRAIN_KAFKA_HOST = env.str('SOMABRAIN_KAFKA_HOST', default=env.str('KAFKA_HOST', default=None))
SOMABRAIN_KAFKA_PORT = env.int('SOMABRAIN_KAFKA_PORT', default=env.int('KAFKA_PORT', default=0))
SOMABRAIN_KAFKA_SCHEME = env.str('SOMABRAIN_KAFKA_SCHEME', default=env.str('KAFKA_SCHEME', default='kafka'))
...
SOMABRAIN_CONSUMER_GROUP = env.str('SOMABRAIN_CONSUMER_GROUP', default='orchestrator-service')

# Milvus
SOMABRAIN_MILVUS_HOST = env.str('MILVUS_HOST', default=env.str('SOMABRAIN_MILVUS_HOST', default=None))
SOMABRAIN_MILVUS_PORT = env.int('MILVUS_PORT', default=env.int('SOMABRAIN_MILVUS_PORT', default=19530))
SOMABRAIN_MILVUS_COLLECTION = env.str('MILVUS_COLLECTION', default='oak_options')
MILVUS_SEGMENT_REFRESH_INTERVAL = env.float('MILVUS_SEGMENT_REFRESH_INTERVAL', default=60.0)
...
# Circuit breaker
SOMABRAIN_CIRCUIT_FAILURE_THRESHOLD = env.int('SOMABRAIN_CIRCUIT_FAILURE_THRESHOLD', default=3)
SOMABRAIN_CIRCUIT_RESET_INTERVAL = env.float('SOMABRAIN_CIRCUIT_RESET_INTERVAL', default=60.0)
SOMABRAIN_CIRCUIT_COOLDOWN_INTERVAL = env.float('SOMABRAIN_CIRCUIT_COOLDOWN_INTERVAL', default=0.0)

# Feature flags for infrastructure
SOMABRAIN_REQUIRE_EXTERNAL_BACKENDS = env.bool('SOMABRAIN_REQUIRE_EXTERNAL_BACKENDS', default=True)
...
SOMABRAIN_LOG_CONFIG = env.str('SOMABRAIN_LOG_CONFIG', default='/app/config/logging.yaml')
...
SOMABRAIN_DEFAULT_BASE_URL = env.str('SOMABRAIN_DEFAULT_BASE_URL', default='http://localhost:9696')
...
SOMABRAIN_INTEGRATOR_HEALTH_PORT = env.int('SOMABRAIN_INTEGRATOR_HEALTH_PORT', default=9015)
SOMABRAIN_INTEGRATOR_HEALTH_URL = env.str('SOMABRAIN_INTEGRATOR_HEALTH_URL', default='http://somabrain_integrator_triplet:9015/health')
SOMABRAIN_SEGMENTATION_HEALTH_URL = env.str('SOMABRAIN_SEGMENTATION_HEALTH_URL', default='http://somabrain_cog:9016/health')

# Kafka topics
SOMABRAIN_TOPIC_CONFIG_UPDATES = env.str('SOMABRAIN_TOPIC_CONFIG_UPDATES', default='cog.config.updates')
SOMABRAIN_TOPIC_NEXT_EVENT = env.str('SOMABRAIN_TOPIC_NEXT_EVENT', default='cog.next_event')
SOMABRAIN_TOPIC_STATE_UPDATES = env.str('SOMABRAIN_TOPIC_STATE_UPDATES', default='cog.state.updates')
SOMABRAIN_TOPIC_AGENT_UPDATES = env.str('SOMABRAIN_TOPIC_AGENT_UPDATES', default='cog.agent.updates')
SOMABRAIN_TOPIC_ACTION_UPDATES = env.str('SOMABRAIN_TOPIC_ACTION_UPDATES', default='cog.action.updates')
SOMABRAIN_TOPIC_GLOBAL_FRAME = env.str('SOMABRAIN_TOPIC_GLOBAL_FRAME', default='cog.global.frame')
...
OUTBOX_API_TOKEN = env.str('OUTBOX_API_TOKEN', default=env.str('SOMA_API_TOKEN', default=None))

# Journal
SOMABRAIN_JOURNAL_DIR = env.str('SOMABRAIN_JOURNAL_DIR', default='/tmp/somabrain_journal')
JOURNAL_REPLAY_INTERVAL = env.int('JOURNAL_REPLAY_INTERVAL', default=300)
SOMABRAIN_JOURNAL_MAX_FILE_SIZE = env.int('SOMABRAIN_JOURNAL_MAX_FILE_SIZE', default=104857600)
SOMABRAIN_JOURNAL_MAX_FILES = env.int('SOMABRAIN_JOURNAL_MAX_FILES', default=10)
SOMABRAIN_JOURNAL_ROTATION_INTERVAL = env.int('SOMABRAIN_JOURNAL_ROTATION_INTERVAL', default=86400)
SOMABRAIN_JOURNAL_RETENTION_DAYS = env.int('SOMABRAIN_JOURNAL_RETENTION_DAYS', default=7)
...
# --- MEMORY SETTINGS ---
# Memory HTTP service
SOMABRAIN_MEMORY_HTTP_HOST = env.str('SOMABRAIN_MEMORY_HTTP_HOST', default=env.str('MEMORY_HTTP_HOST', default=None))
SOMABRAIN_MEMORY_HTTP_PORT = env.int('SOMABRAIN_MEMORY_HTTP_PORT', default=env.int('MEMORY_HTTP_PORT', default=0))
SOMABRAIN_MEMORY_HTTP_SCHEME = env.str('SOMABRAIN_MEMORY_HTTP_SCHEME', default=env.str('MEMORY_HTTP_SCHEME', default='http'))
SOMABRAIN_MEMORY_HTTP_ENDPOINT = env.str('SOMABRAIN_MEMORY_HTTP_ENDPOINT', default=env.str('MEMORY_SERVICE_URL', default='http://localhost:9595'))
...
# Memory weighting
SOMABRAIN_MEMORY_ENABLE_WEIGHTING = env.bool('SOMABRAIN_FF_MEMORY_WEIGHTING', default=env.bool('SOMABRAIN_MEMORY_ENABLE_WEIGHTING', default=False))
...
# Memory degradation
SOMABRAIN_MEMORY_DEGRADE_QUEUE = env.bool('SOMABRAIN_MEMORY_DEGRADE_QUEUE', default=True)
SOMABRAIN_MEMORY_DEGRADE_READONLY = env.bool('SOMABRAIN_MEMORY_DEGRADE_READONLY', default=False)
SOMABRAIN_MEMORY_DEGRADE_TOPIC = env.str('SOMABRAIN_MEMORY_DEGRADE_TOPIC', default='memory.degraded')
SOMABRAIN_MEMORY_HEALTH_POLL_INTERVAL = env.float('SOMABRAIN_MEMORY_HEALTH_POLL_INTERVAL', default=5.0)
...
SOMABRAIN_WM_RECENCY_TIME_SCALE = env.float('SOMABRAIN_WM_RECENCY_TIME_SCALE', default=1.0)
...
SOMABRAIN_WM_SALIENCE_THRESHOLD = env.float('SOMABRAIN_WM_SALIENCE_THRESHOLD', default=0.4)
SOMABRAIN_WM_PER_COL_MIN_CAPACITY = env.int('SOMABRAIN_WM_PER_COL_MIN_CAPACITY', default=16)
SOMABRAIN_WM_VOTE_SOFTMAX_FLOOR = env.float('SOMABRAIN_WM_VOTE_SOFTMAX_FLOOR', default=1e-4)
SOMABRAIN_WM_VOTE_ENTROPY_EPS = env.float('SOMABRAIN_WM_VOTE_ENTROPY_EPS', default=1e-9)
SOMABRAIN_WM_PER_TENANT_CAPACITY = env.int('SOMABRAIN_WM_PER_TENANT_CAPACITY', default=128)
...
SOMABRAIN_MICRO_VOTE_TEMPERATURE = env.float('SOMABRAIN_MICRO_VOTE_TEMPERATURE', default=0.25)
...
SOMABRAIN_CLEANUP_HNSW_EF_CONSTRUCTION = env.int('SOMABRAIN_CLEANUP_HNSW_EF_CONSTRUCTION', default=200)
SOMABRAIN_CLEANUP_HNSW_EF_SEARCH = env.int('SOMABRAIN_CLEANUP_HNSW_EF_SEARCH', default=128)
...
SOMABRAIN_RECALL_SIMPLE_DEFAULTS = env.bool('SOMABRAIN_RECALL_SIMPLE_DEFAULTS', default=False)
SOMABRAIN_RECALL_DEFAULT_RERANK = env.str('SOMABRAIN_RECALL_DEFAULT_RERANK', default='auto')
SOMABRAIN_RECALL_DEFAULT_PERSIST = env.bool('SOMABRAIN_RECALL_DEFAULT_PERSIST', default=True)
SOMABRAIN_RECALL_DEFAULT_RETRIEVERS = env.str('SOMABRAIN_RECALL_DEFAULT_RETRIEVERS', default='vector,wm,graph,lexical')
...
SOMABRAIN_SALIENCE_THRESHOLD_STORE = env.float('SOMABRAIN_SALIENCE_THRESHOLD_STORE', default=0.5)
SOMABRAIN_SALIENCE_THRESHOLD_ACT = env.float('SOMABRAIN_SALIENCE_THRESHOLD_ACT', default=0.7)
...
SOMABRAIN_SALIENCE_FD_ENERGY_FLOOR = env.float('SOMABRAIN_SALIENCE_FD_ENERGY_FLOOR', default=0.9)
SOMABRAIN_SALIENCE_SOFT_TEMPERATURE = env.float('SOMABRAIN_SALIENCE_SOFT_TEMPERATURE', default=0.1)
...
SOMABRAIN_PLANNER_RWR_MAX_NODES = env.int('SOMABRAIN_PLANNER_RWR_MAX_NODES', default=128)
SOMABRAIN_PLANNER_RWR_EDGES_PER_NODE = env.int('SOMABRAIN_PLANNER_RWR_EDGES_PER_NODE', default=32)
...
SOMABRAIN_TAU_ANNEAL_STEP_INTERVAL = env.int('SOMABRAIN_TAU_ANNEAL_STEP_INTERVAL', default=0)
...
SOMABRAIN_ENABLE_ADVANCED_LEARNING = env.bool('SOMABRAIN_ENABLE_ADVANCED_LEARNING', default=True)
SOMABRAIN_LEARNING_RATE_DYNAMIC = env.bool('SOMABRAIN_LEARNING_RATE_DYNAMIC', default=False)

# Learning tenant configuration
SOMABRAIN_LEARNING_TENANTS_OVERRIDES = env.str('SOMABRAIN_LEARNING_TENANTS_OVERRIDES', default=None)
LEARNING_TENANTS_CONFIG = env.str('LEARNING_TENANTS_CONFIG', default=None)
SOMABRAIN_LEARNING_TENANTS_FILE = env.str('SOMABRAIN_LEARNING_TENANTS_FILE', default=None)
...
SOMABRAIN_NEURO_SEROTONIN_BASE = env.float('SOMABRAIN_NEURO_SEROTONIN_BASE', default=0.5)
...
SOMABRAIN_NEURO_DOPAMINE_REWARD_BOOST = env.float('SOMABRAIN_NEURO_DOPAMINE_REWARD_BOOST', default=0.1)
SOMABRAIN_NEURO_DOPAMINE_BIAS = env.float('SOMABRAIN_NEURO_DOPAMINE_BIAS', default=0.05)
SOMABRAIN_NEURO_URGENCY_FACTOR = env.float('SOMABRAIN_NEURO_URGENCY_FACTOR', default=0.02)
...
SOMABRAIN_NEURO_ACCURACY_SCALE = env.float('SOMABRAIN_NEURO_ACCURACY_SCALE', default=0.05)

# Sleep system
SOMABRAIN_ENABLE_SLEEP = env.bool('SOMABRAIN_ENABLE_SLEEP', default=True)
SOMABRAIN_CONSOLIDATION_ENABLED = env.bool('SOMABRAIN_CONSOLIDATION_ENABLED', default=True)
SOMABRAIN_SLEEP_INTERVAL_SECONDS = env.int('SOMABRAIN_SLEEP_INTERVAL_SECONDS', default=3600)
SOMABRAIN_CONSOLIDATION_TIMEOUT_S = env.float('SOMABRAIN_CONSOLIDATION_TIMEOUT_S', default=30.0)
SOMABRAIN_NREM_BATCH_SIZE = env.int('SOMABRAIN_NREM_BATCH_SIZE', default=16)
SOMABRAIN_MAX_SUMMARIES_PER_CYCLE = env.int('SOMABRAIN_MAX_SUMMARIES_PER_CYCLE', default=3)
...
SOMABRAIN_UTILITY_MU = env.float('SOMABRAIN_UTILITY_MU', default=0.1)
SOMABRAIN_UTILITY_NU = env.float('SOMABRAIN_UTILITY_NU', default=0.05)
SOMABRAIN_ADAPTATION_GAIN_ALPHA = env.float('SOMABRAIN_ADAPTATION_GAIN_ALPHA', default=1.0)
SOMABRAIN_ADAPTATION_GAIN_GAMMA = env.float('SOMABRAIN_ADAPTATION_GAIN_GAMMA', default=-0.5)
SOMABRAIN_ADAPTATION_GAIN_LAMBDA = env.float('SOMABRAIN_ADAPTATION_GAIN_LAMBDA', default=1.0)
...
SOMABRAIN_ADAPTATION_ALPHA_MIN = env.float('SOMABRAIN_ADAPTATION_ALPHA_MIN', default=0.1)
SOMABRAIN_ADAPTATION_ALPHA_MAX = env.float('SOMABRAIN_ADAPTATION_ALPHA_MAX', default=5.0)
SOMABRAIN_ADAPTATION_GAMMA_MIN = env.float('SOMABRAIN_ADAPTATION_GAMMA_MIN', default=0.0)
SOMABRAIN_ADAPTATION_GAMMA_MAX = env.float('SOMABRAIN_ADAPTATION_GAMMA_MAX', default=1.0)
SOMABRAIN_ADAPTATION_LAMBDA_MIN = env.float('SOMABRAIN_ADAPTATION_LAMBDA_MIN', default=0.1)
SOMABRAIN_ADAPTATION_LAMBDA_MAX = env.float('SOMABRAIN_ADAPTATION_LAMBDA_MAX', default=5.0)
...
SOMABRAIN_OUTBOX_SYNC_INTERVAL = env.float('SOMABRAIN_OUTBOX_SYNC_INTERVAL', default=10.0)
SOMABRAIN_MILVUS_RECONCILE_INTERVAL = env.float('SOMABRAIN_MILVUS_RECONCILE_INTERVAL', default=3600.0)
SOMABRAIN_MEMORY_HEALTH_POLL_INTERVAL = env.int('SOMABRAIN_MEMORY_HEALTH_POLL_INTERVAL', default=60)
SOMABRAIN_MEMORY_FAST_ACK = env.bool('SOMABRAIN_MEMORY_FAST_ACK', default=False)
...
SOMABRAIN_SEGMENTATION_HEALTH_PORT = env.int('SOMABRAIN_SEGMENTATION_HEALTH_PORT', default=9016)

# Drift monitoring
SOMABRAIN_DRIFT_STORE = env.str('SOMABRAIN_DRIFT_STORE', default='./data/drift/state.json')
...
SOMABRAIN_CONTEXT_BUDGET_TOKENS = env.int('SOMABRAIN_CONTEXT_BUDGET_TOKENS', default=2048)
