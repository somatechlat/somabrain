...
MESSAGES = {
    ...
    ErrorCode.BRAIN_SETTING_NOT_FOUND: _(
        "Brain setting '{key}' not found for tenant '{tenant}'. Run initialize_defaults() first."
    ),
    ErrorCode.BRAIN_SETTING_INVALID_TYPE: _(
        "Invalid value type '{value_type}' for setting '{key}'"
    ),
    ErrorCode.BRAIN_INITIALIZATION_FAILED: _(
        "Failed to initialize brain defaults: {error}"
    ),
