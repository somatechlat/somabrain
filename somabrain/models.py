...
class OutboxEvent(models.Model):
    ...
    status = models.CharField(
        max_length=50, default="pending", db_index=True
    )  # pending, sent, failed
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["tenant_id", "dedupe_key"], name="uq_outbox_tenant_dedupe"
            )
        ]
        indexes = [
            models.Index(
...
class ConstitutionSignature(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["checksum", "signer_id"], name="uq_constitution_signature"
            )
        ]
        ordering = ["created_at"]
        indexes = [
