...
helllo ! I need yo to go to to the whole somabrain folder  adn read all the PYTHON CODE , ALL THIS CODE NEED TO BE MIGRATED TO DJANGO + DJANGO NINGA_ SETTINS_ ALL THE DJANGO STACK 